    ...
    <form name="RecruitWrite" id="RecruitWrite" method="post">
        <div class="container">
            ...
            <div class="inner" id="contents">
                <!-- 상세 : s -->
                <h2 class="subTopTitle">자주묻는질문 등록</h2>
                ...
                <div class="btnBottomArea tac">
                    <p href="javascript:save()" id="save" class="btnText recruit" @click="createFAQ()"><span>질문 등록 하기</span></p>
                </div>
...
async function createFAQ(){
    const url: string = 'http://125.131.88.58:8055/items/kb_'  + type.value
